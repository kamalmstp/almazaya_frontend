      ...
      <div class="slider-item" style="background-image:url(assets/images/2.png);">
        ...
        <div class="container">
          ...
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">Al Mazaya Islamic School</h1>
            <p>do you want to join us ?</p>
            <p><a href="http://www.almazayaislamicschool.sch.id/formulir-penerimaan-peserta-didik-baru" class="btn btn-primary px-4 py-3 mt-3">Register Now</a></p>
          </div>
        </div>
        </div>
      </div>
          ...
          <?php foreach($berita as $row) { 
           ...
           <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('<?=base_url('media_library/posts/medium/'.$row["post_image"])?>');" alt="<?=$row["post_title"]?>">
              ...
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
                  <p class="mb-0"><a href="http://www.almazayaislamicschool.sch.id" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
